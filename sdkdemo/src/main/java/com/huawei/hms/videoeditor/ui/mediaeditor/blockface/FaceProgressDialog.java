...
public class FaceProgressDialog extends BaseDialog {
    ...
    public FaceProgressDialog(@NonNull Context context, String title) {
    ...
    public void setProgress(int progress) {
        ...
        tvProgress.setText(NumberFormat.getPercentInstance()
            .format(BigDecimalUtil.div(progress, 100, 2)));
    }
