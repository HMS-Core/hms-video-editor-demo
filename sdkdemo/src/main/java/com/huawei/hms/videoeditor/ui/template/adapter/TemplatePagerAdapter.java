...
public class TemplatePagerAdapter extends RMCommandAdapter<HVETemplateInfo> {
    public TemplatePagerAdapter(Context context, List<HVETemplateInfo> list,
        TemplateItemView.OnItemClickListener itemClickListener) {
        super(context, list);
        addItemViewDelegate(new TemplateItemView(context, itemClickListener));
    }
}
